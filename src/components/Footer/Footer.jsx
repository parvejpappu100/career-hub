...
const Footer = () => {
    return (
        <div className='mt-32 bg-base-200'>
            <footer className="footer p-10 lg:container mx-auto px-4  text-black">
                <nav>
            ...
            <footer className="footer px-4 lg:container mx-auto py-4 border-t  text-black border-base-300">
